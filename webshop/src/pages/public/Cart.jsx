...
function Cart() {
  ...
  const [parcelMachines, setParcelMachines] = useState([]); // alväärtus, mis on senikaua kuni API päring teostub
  ...
  return (
    <div>
      ...
      {cart.length > 0 && <Button variant="outline" onClick={empty}>Empty</Button>}
