...
function MuudaToode() {
  ...
  const { index } = useParams(); //import ka. Reacti hook (tegemist on imporditava koodiga, mida ei eksisteer
  // tavalises JaveScriptis. Imporditakse mingisugune funktsionaalsus node_modulest)
  // useSuperpower
  ...
  const muuda = () => {
    ...
    //siis võiks teha URLi vahetuse koodilõigu järel (selleks vaja seda teha JavaScriptis)
