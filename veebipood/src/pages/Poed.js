...
function Poed() {
    ...
    const sorteeriAZ = () => {
        // poed.sort(); //sort on default, sorteeribki A-Z
    ...
    const sorteeriZA = () => {
        ...
        // poed.sort((first, secpmd) => second.localeCompare(first));
  ...
  return (
    <div>
        ...
        <button onClick={filtreeriRohkemTahtiKui7}>Filtreeri rohkem kui 7 tähelised</button>
        <button onClick={filtreeriSisaldabTahtiIs}>Filtreeri sõnad mis sisaldavad "IS"</button>
        <button onClick={filtreeriKolmasTahtI}>Filtreeri sõnad, kus kolmas täht "I"</button>
        <button onClick={filtreeriTahti9}>Filtreeri sõnad, kus tähti 9</button>
        <br /><br />
